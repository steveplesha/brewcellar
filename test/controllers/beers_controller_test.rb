...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery: @beer.brewery, brewyear: @beer.brewyear, name: @beer.name, quantity: @beer.quantity, size: @beer.size }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { brewery: @beer.brewery, brewyear: @beer.brewyear, name: @beer.name, quantity: @beer.quantity, size: @beer.size }
    assert_redirected_to beer_path(assigns(:beer))
  end
